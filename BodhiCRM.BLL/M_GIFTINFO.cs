...
namespace BodhiCRM.BLL
{
	...
	{
		private readonly BodhiCRM.DAL.M_GIFTINFO dal=new BodhiCRM.DAL.M_GIFTINFO();
		public M_GIFTINFO()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public BodhiCRM.Model.M_GIFTINFO GetModelByCache(decimal ID)
		{
			
			string CacheKey = "M_GIFTINFOModel-" + ID;
			...
			return (BodhiCRM.Model.M_GIFTINFO)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<BodhiCRM.Model.M_GIFTINFO> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<BodhiCRM.Model.M_GIFTINFO> DataTableToList(DataTable dt)
		{
			List<BodhiCRM.Model.M_GIFTINFO> modelList = new List<BodhiCRM.Model.M_GIFTINFO>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				BodhiCRM.Model.M_GIFTINFO model;
