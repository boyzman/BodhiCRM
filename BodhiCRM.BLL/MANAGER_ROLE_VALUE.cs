...
namespace BodhiCRM.BLL
{
	...
	{
		private readonly BodhiCRM.DAL.MANAGER_ROLE_VALUE dal=new BodhiCRM.DAL.MANAGER_ROLE_VALUE();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public BodhiCRM.Model.MANAGER_ROLE_VALUE GetModelByCache(decimal ID)
		{
			
			string CacheKey = "MANAGER_ROLE_VALUEModel-" + ID;
			...
			return (BodhiCRM.Model.MANAGER_ROLE_VALUE)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<BodhiCRM.Model.MANAGER_ROLE_VALUE> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<BodhiCRM.Model.MANAGER_ROLE_VALUE> DataTableToList(DataTable dt)
		{
			List<BodhiCRM.Model.MANAGER_ROLE_VALUE> modelList = new List<BodhiCRM.Model.MANAGER_ROLE_VALUE>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				BodhiCRM.Model.MANAGER_ROLE_VALUE model;
