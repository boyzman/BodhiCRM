...
namespace BodhiCRM.BLL
{
	...
	{
		private readonly BodhiCRM.DAL.VISIT dal=new BodhiCRM.DAL.VISIT();
		public VISIT()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public BodhiCRM.Model.VISIT GetModelByCache(decimal ID)
		{
			
			string CacheKey = "VISITModel-" + ID;
			...
			return (BodhiCRM.Model.VISIT)objModel;
		}
        ...
        {
            return dal.GetList_ByEmpl(strWhere);
        }
		/// <summary>
		/// 获得数据列表
		/// </summary>
		public List<BodhiCRM.Model.VISIT> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<BodhiCRM.Model.VISIT> DataTableToList(DataTable dt)
		{
			List<BodhiCRM.Model.VISIT> modelList = new List<BodhiCRM.Model.VISIT>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				BodhiCRM.Model.VISIT model;
