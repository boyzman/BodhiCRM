...
namespace BodhiCRM.BLL
{
	...
	{
		private readonly BodhiCRM.DAL.EMPLOYEE dal=new BodhiCRM.DAL.EMPLOYEE();
		public EMPLOYEE()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public BodhiCRM.Model.EMPLOYEE GetModelByCache(decimal ID)
		{
			...
			return (BodhiCRM.Model.EMPLOYEE)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<BodhiCRM.Model.EMPLOYEE> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<BodhiCRM.Model.EMPLOYEE> DataTableToList(DataTable dt)
		{
			List<BodhiCRM.Model.EMPLOYEE> modelList = new List<BodhiCRM.Model.EMPLOYEE>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				BodhiCRM.Model.EMPLOYEE model;
