...
{
    public partial class archives_list : Web.Aid.ManagePage
    {
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Repeater rep_home = e.Item.FindControl("rptList_homecare") as Repeater;
                Repeater rep_out = e.Item.FindControl("rptList_outpatient") as Repeater;
                ...
                BLL.HOMECARE bll_home = new BLL.HOMECARE();
                rep_home.DataSource = bll_home.GetList(sWhere);
                rep_home.DataBind();

                BLL.OUTPATIENT bll_out = new BLL.OUTPATIENT();
                rep_out.DataSource = bll_out.GetList("r."+sWhere);
                rep_out.DataBind();
