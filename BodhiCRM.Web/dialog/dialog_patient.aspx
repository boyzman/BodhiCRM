<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_patient.aspx.cs" Inherits="BodhiCRM.Web.dialog.dialog_patient" %>
...
<script type="text/javascript">
    ...
    function setPatientInfo() {
        ...
        else if (sn_value.length > 1) {
            alert('只能选择一位病患的信息！');
        }
        else
        {
            
            $(api.data).parent().find("input[name='hidSn']").val(sn_value[0]);
            $(api.data).parent().find("input[name='txtPNAME']").val(name_value[0]);
