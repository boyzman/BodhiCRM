...
{
    public partial class manager_log : Web.Aid.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                RptBind("HOSPITAL_CODE='" + model.HOSPITAL_CODE + "' and id>0" + CombSqlTxt(keywords), "add_time desc,id desc");
            }
        }
        ...
        {
            int _pagesize;
            if (int.TryParse(Utils.GetCookie("manager_page_size", "BodhiCRMPage"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Utils.WriteCookie("manager_page_size", "BodhiCRMPage", _pagesize.ToString(), 14400);
                }
            }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            BLL.MANAGER_LOG bll = new BLL.MANAGER_LOG();
            int sucCount = bll.Delete_Before(7);
