<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_edit.aspx.cs" Inherits="BodhiCRM.Web.manager.role_edit" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <%--<dl>
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlHospitalCode" runat="server" datatype="*" errormsg="请选择院区！" sucmsg=" ">
            <asp:ListItem Value="0" Selected="True">百洋医院总院</asp:ListItem>
          <asp:ListItem Value="1">百洋医院一院</asp:ListItem>
          <asp:ListItem Value="2">百洋医院二院</asp:ListItem>
        </asp:DropDownList>
      </div>
    </dd>
  </dl>--%>
